            ...
            <PokemonConsumer>
                {({ updatepokemon }) => (
                    <Container fluid={true} className="py-5">
                        ...
                        <Col >
                                    <Card body>
                                        <CardTitle align="center" tag="h1">{name}</CardTitle>
                                        <CardText>
                                           <Row>
                                                ...
                                                <Col className="col-md-5 mx-auto">
                                                    <Row>
                                                        <Col>ID</Col>
                                                        <Col><Button color="success" variant="danger">{pokemon_details.id}</Button></Col> 
                                                    </Row>
                                                    <Row>
                                                        <Col>HEIGHT</Col>
                                                        <Col><Button color="success" variant="danger">{pokemon_details.height}</Button></Col> 
                                                    </Row>
                                                    <Row>
                                                        <Col>WEIGHT</Col>
                                                        <Col><Button color="success" variant="danger">{pokemon_details.weight}</Button></Col> 
                                                    </Row>
                                                    <Row>
                                                        <Col>ABILITIES</Col>
                                                        <Col> {
                                                                pokemon_details.abilities ?
                                                                    pokemon_details.abilities.map(ab => {
                                                                        ...
                                                                        return (
                                                                            ...
                                                                            <li className="text-capitalize" key={ability.name}>{ability.name}</li>
                                                                        );
                                                                    }) : null
                                                            }
                                                        </Col> 
                                                    ...
                                                    <Col>
                                                            {
                                                                pokemon_details.stats ?
                                                                    pokemon_details.stats.map(item => {
                                                                        const { stat } = item;
                                                                        return (
                                                                            <li className="text-capitalize" key={stat.name}>{stat.name}{item.base_sta}</li>
                                               ...
                                               <Col>
                                                    <Row className="justify-content-center mb-4" >Action</Row>
                                                    ...
                                                    <Row className="justify-content-center mb-4">
                                                            <Link to="/pokemon-list">
                                                                <Button color="warning" className="w-100">Back To List</Button>
                                                            </Link>
                                                    </Row>
